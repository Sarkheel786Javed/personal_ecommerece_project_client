        ...
        return (
            <div className="">
                ...
                <div className="d-flex justify-content-center align-items-center gap-2">
                    <div className="">
                        <div className="offer_timer bg-light border d-flex justify-content-center align-items-center fs-2">{formatTime(hours)}</div>
                        Hours
                    </div>
                    <div className="">
                        <div className="offer_timer bg-light border d-flex justify-content-center align-items-center fs-2">{formatTime(minutes)}</div>
                        MINS
                    </div>
                    <div className="">
                        <div className="offer_timer bg-light border d-flex justify-content-center align-items-center fs-2">{formatTime(seconds)}</div>
                        SECS
                    </div>
                </div>
            ...
            <div className="container-fluid">
                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 border border-warning card_cover p-3">
                    ...
                    <div className=" img_section mt-3 ">
                        <img src="" className="cursor_pointer" alt="...." width="100%" height="100%" />
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3">
                        <label className="">Available: <label className="fw-bold">6</label></label>
                        <label className="">Already Sold: <label className="fw-bold">28</label></label>
                    </div>
                    <div className="progress_bar border bg-light">
                        <div className="bg-warning progress_bar_inner"
